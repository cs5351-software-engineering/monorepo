...
export class Project {
  ...
  @Column({ name: 'SonarQubeAnalysisResult', type: 'text', nullable: true })
  sonarQubeAnalysisResult: SonarQubeAnalysisResult | null;

  @OneToMany(
    () => AuthorizedProject,
    (authorizedProject) => authorizedProject.project,
  )
